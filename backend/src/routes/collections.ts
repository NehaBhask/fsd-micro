...
// GET /api/collections/docs/:shareId — PUBLIC: fetch or export docs
// NOTE: Must be declared before /:id routes to avoid param collision
router.get('/docs/:shareId', async (req: Request, res: Response) => {
  try {
...
// GET /api/collections — all collections with requests
...
// POST /api/collections/:id/unshare — revoke share
...
// POST /api/collections/:id/docs — generate documentation (auto-enables sharing)
router.post('/:id/docs', authMiddleware, async (req: Request, res: Response) => {
  try {
...
// GET /api/collections/shared/:shareId — PUBLIC: raw collection data for import
...
// POST /api/collections/import/:shareId — import a shared collection
